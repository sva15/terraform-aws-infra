...
s3_bucket_name   = "staging-ifrs-insightgen-bucket"

# UI Configuration
use_local_ui_source  = false
ui_s3_bucket         = "staging-ifrs-ui-assets"
ui_s3_key            = "ui-assets.zip"
ui_assets_local_path = "../../ui"
ui_path              = "/var/www/html"
BASE_URL             = "https://staging.ifrs-insightgen.com"

# ECR Configuration
ecr_repositories = ["staging-ifrs-app"]
...
postgres_db_name    = "staging_ifrs_db"
postgres_port       = 5432
use_secrets_manager = true
pgadmin_email       = "admin@staging.ifrs-insightgen.com"
pgadmin_port        = 8080

# SQL Backup Configuration
sql_backup_s3_bucket  = "staging-ifrs-db-backups"
sql_backup_s3_key     = "backups/staging_backup.sql"
